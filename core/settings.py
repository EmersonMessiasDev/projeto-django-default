...
SECRET_KEY = 'django-insecure-^9_0yqf4cfkie5(%a%+z1400#61$^w2%+k6uzcnwbyd^ptdr(z'
...
#         'NAME': 'ruszon_defconect',
#         'USER':  'ruszon_defconect',
#         'PASSWORD': '******',
...
# }
#! PostgreSQL
#? primeiro instale a biblioteca pip install psycopg2
# DATABASES = {
#         'default': {
